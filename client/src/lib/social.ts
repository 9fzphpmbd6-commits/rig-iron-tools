...
/** Fetch latest posts tagged with #RigIronBuilds — replace with real API */
  ...
  return [
    {
      ...
      caption: "Dropping holes all day with the Elite 50. #RigIronBuilds",
      imageUrl: "",
      postUrl: "#",
    ...
    },
    {
      ...
      caption: "SITEH3RO step reamer in action on the bridge job. #RigIronBuilds",
      imageUrl: "",
      postUrl: "#",
    ...
    },
    {
      ...
      caption: "New Commando 40 just arrived. Review coming soon. #RigIronBuilds",
      imageUrl: "",
      postUrl: "#",
...
export function getShareUrl(platform: "x" | "facebook", productUrl: string, productName: string): string {
  const text = encodeURIComponent(`Check out the ${productName} at Rig Iron Tools!`);
