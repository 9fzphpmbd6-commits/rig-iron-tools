...
export const products: Product[] = [
  // ── SITEH3RO TOOLS ──────────────────────────────
  {
    ...
    shortDescription: 'Impact-ready step reamer covering 9/16" to 13/16" in a single tool.',
    longDescription: 'The SITEH3RO Step Reamer 9/16"–13/16" is built for impact wrenches and drills alike. Its proprietary SITEH3RO coating delivers up to 75% longer tool life compared to standard HSS reamers. Each step is precision-ground to match common bolt sizes used in structural steel, bridge work, and plant maintenance. One tool replaces a drawer full of individual reamers.',
    keyFeatures: [
      "SITEH3RO coating — up to 75% longer life",
      "Impact-wrench compatible (7/16\" hex shank)",
      'Covers 9/16" to 13/16" in single tool',
  ...
  },
  {
    ...
    category: "siteh3ro",
    subcategory: "step-reamer",
    shortDescription: 'Compact step reamer for smaller bolt sizes from 5/16" to 9/16", impact-wrench ready.',
  ...
  },
  {
    ...
    shortDescription: 'Large-range step drill for impact wrenches — cuts clean holes up to 1 3/8".',
    longDescription: 'When you need to drill and size holes in one pass, the SITEH3RO Step Drill 1/4"–1 3/8" handles it. Designed for use with impact wrenches on structural steel, this drill features the signature SITEH3RO coating for extended life under heavy use. Each step is laser-marked for easy size identification on the jobsite.',
    keyFeatures: [
  ...
  },
  {
    ...
    shortDescription: 'Precision 1/2" car reamer for aligning and expanding bolt holes in steel connections.',
    longDescription: 'The SITEH3RO Car Reamer is the tool steel erectors reach for when bolt holes don\'t quite line up. This 1/2" reamer cleans, aligns, and expands holes in structural connections. The SITEH3RO coating lets you ream dozens of holes before showing wear. Use with an impact wrench for fast work at height.',
    keyFeatures: [
  ...
  },
  {
    ...
    category: "siteh3ro",
    subcategory: "tap",
    shortDescription: 'Impact-ready 1/2" UNC spiral point tap for threading holes directly on the jobsite.',
    longDescription: 'Thread holes in structural steel without a bench setup. The SITEH3RO 1/2" UNC Tap features a 7/16" hex shank for impact wrenches and the proprietary coating that resists heat and wear far longer than standard HSS taps. Ideal for adding threaded connections on-site during construction and maintenance.',
    keyFeatures: [
      "Impact-wrench compatible threading",
      "SITEH3RO coating for heat resistance",
      '1/2" UNC thread',
      "Spiral point for chip evacuation",
  ...
  },
  {
    ...
    longDescription: 'This 3-piece kit covers the full range of common bolt sizes from 5/16" to 1 1/16". All three reamers feature the SITEH3RO coating and 7/16" hex shanks for impact wrenches. Comes in a rugged carrying case that fits in a tool bag. This is the kit steel crews keep in the gang box.',
    keyFeatures: [
  ...
  },
  {
    ...
    longDescription: "Everything a steel crew needs in one case. The Ultimate Kit includes 3 step drills, 3 step reamers, 3 car reamers, and 3 taps — plus 2 holders — all with SITEH3RO coating and impact-wrench compatibility. Covers drilling, threading, aligning, and expanding holes in metal. This is the flagship set for crews who want one kit that handles every hole-making task on structural steel.",
    keyFeatures: [
      "Complete 14-piece system: drill, ream, thread, align",
      "All tools SITEH3RO-coated for 75% longer life",
      "Impact-wrench ready across the board",
      "Heavy-duty case with labeled slots",
      "Covers all common bolt sizes",
    ],
    specs: {
      "Pieces": "14",
      "Includes": "3 step drills, 3 step reamers, 3 car reamers, 3 taps, 2 holders",
  ...
  },
  {
    ...
    category: "siteh3ro",
    subcategory: "step-drill",
    shortDescription: 'Mid-range step drill for everyday steel and sheet-metal drilling up to 7/8".',
    longDescription: 'A versatile step drill that handles common hole sizes from 3/16" to 7/8". The SITEH3RO coating keeps the cutting edges sharp through extended use on mild steel, stainless, and aluminum. Split-point tip prevents walking on flat surfaces.',
    keyFeatures: [
      "SITEH3RO coating",
      "Impact-wrench compatible",
      '3/16" to 7/8" range',
